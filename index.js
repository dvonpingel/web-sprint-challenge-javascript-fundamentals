...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
// Because of closure, functions inside functions can reach out and pull anything outside of them. Just as the myFunction can pull global variables.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(arr){
    let newArr = arr.map(arr => arr.animal_name.toLowerCase());
    return newArr;
  }
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    let lowPop = arr.filter(arr => arr.population < 5);
    return lowPop;
  }
  ...
  */
  ...
  function USApop(arr){
    let totalPop = arr.reduce(function(counter, animal) {
